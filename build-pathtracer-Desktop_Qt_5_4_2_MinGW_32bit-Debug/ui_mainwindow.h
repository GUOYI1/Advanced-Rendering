...
public:
    ...
    QCheckBox *checkBox_kd;
    QComboBox *integratorSpinBox_2;
    QMenuBar *menuBar;
    QMenu *menuFile;
    QMenu *menuHelp;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(10, 20, 611, 96));
        ...
        checkBox_kd = new QCheckBox(layoutWidget);
        checkBox_kd->setObjectName(QStringLiteral("checkBox_kd"));

        gridLayout->addWidget(checkBox_kd, 2, 5, 1, 1);

        integratorSpinBox_2 = new QComboBox(layoutWidget);
        integratorSpinBox_2->setObjectName(QStringLiteral("integratorSpinBox_2"));

        gridLayout->addWidget(integratorSpinBox_2, 2, 1, 1, 2);
        ...
        QObject::connect(checkBox_kd, SIGNAL(toggled(bool)), mygl, SLOT(slot_UseKD(bool)));
        QObject::connect(integratorSpinBox_2, SIGNAL(currentIndexChanged(int)), mygl, SLOT(slot_SetCameraType(int)));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_5->setText(QApplication::translate("MainWindow", "Camera type:", 0));
        ...
        checkBox_kd->setText(QApplication::translate("MainWindow", "Make kd tree", 0));
        integratorSpinBox_2->clear();
        integratorSpinBox_2->insertItems(0, QStringList()
         << QApplication::translate("MainWindow", "Base Camera", 0)
         << QApplication::translate("MainWindow", "Len_Base Camera", 0)
        );
