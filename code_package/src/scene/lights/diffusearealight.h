...
public:
    ...
    virtual Color3f L(const Base_Intersection &isect, const Vector3f &w) const;
    ...
    Color3f Sample_Li(const Base_Intersection &ref, const Point2f &xi,
                                         Vector3f *wi, Float *pdf, Intersection *LightSample=nullptr) const;


    virtual float Pdf_Li(const Base_Intersection &ref, const Vector3f &wiW) const;
