...
//        rough = RoughnessToAlpha(rough);
        ...
        //Uncomment this if you want to test the BeckmannDistribution effect
//        MicrofacetDistribution* distrib = new BeckmannDistribution(rough, rough);
        //Uncomment this if you want to test the BlinnDistribution effect
//        MicrofacetDistribution* distrib = new BlinnDistribution(4.0f);
//        MicrofacetDistribution* distrib = new BlinnDistribution(rough);
        isect->bsdf->Add(new MicrofacetBTDF(color, distrib, 1.f, indexOfRefraction, new FresnelDielectric(1.f, indexOfRefraction)));
    }
