...
//        MicrofacetDistribution* distrib = new BlinnDistribution(25.0f);

        //Uncomment this if you want to test the CustomDistribution effect
//        MicrofacetDistribution* distrib = new CustomDistribution(rough);
